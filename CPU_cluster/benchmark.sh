...
srun -N $2 $1 27 256 256 256 100 ${DATAPATH}/stencil_data_256x256x256
srun -N $2 $1 27 384 384 384 100 ${DATAPATH}/stencil_data_384x384x384
srun -N $2 $1 27 512 512 512 100 ${DATAPATH}/stencil_data_512x512x512